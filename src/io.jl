...
function printMesh(mesh)
    ...
    println("           numberOfCells: ", length(mesh.cells))
    println("              boundaries: ", typeof(mesh.boundaries))
    println("      numberOfBoundaries: ", length(mesh.boundaries))
    println("   numberOfInteriorFaces: ", mesh.boundaries[1].startFace - 1)
    println("   numberOfBoundaryFaces: ", length(mesh.faces) - mesh.boundaries[1].startFace + 1) 
end